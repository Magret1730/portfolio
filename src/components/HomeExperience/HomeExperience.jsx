					...
					<div className="experience__column">
						<div className="experience__exp-items">
							<div className="experience__exp-item">
								...
								<p className="fade-in-left stagger-1">
									Maintained technical documentation to support team
							...
							<div className="experience__exp-item">
								...
								<p className="fade-in-left stagger-1">
									Built and styled 10+ responsive pages using Next.js,
									MaterialUI and TypeScript, ensuring consistent design and
									accessibility.
								</p>
								<p className="fade-in-left stagger-1">
